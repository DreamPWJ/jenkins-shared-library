...
vllm/vllm-openai:latest  python -m vllm.entrypoints.openai.api_server --model deepseek-ai/DeepSeek-R1-Distill-Qwen-7B --trust-remote-code --host 0.0.0.0 --port 8000 --gpu-memory-utilization 0.5 --dtype half --max-model-len 8192
##### Ollama只有CPU模式部署
