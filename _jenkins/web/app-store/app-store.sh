...
# node $HOME/AppStore/app-store-connect-api.js --appIdentifier='AnTaiKeji.com.saasMangerHaoYu' --appVersion='1.0.0' --apiKeyId='BNL32GR27G' --privateKey="/Library/AuthKey_BNL32GR27G.p8" --issuerId='a0cae47e-ca4b-4503-a967-4282302c0c5a' --phone='15063309617'
