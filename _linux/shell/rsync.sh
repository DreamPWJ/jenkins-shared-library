...
# 全量将远程内容同步到本地  --bwlimit=1000 限速1000KB/s
rsync -avzP --progress --bwlimit=5120 root@119.188.90.222:/nfsdata/ParkPicture/stor1/2023/ /mnt/nfs_data/ParkPicture/stor1/2023/
