...
/var/lib/mysql \
mysql --group_concat_max_len=1024000000 --max_connections=2000 --lower_case_table_names=1
...
sudo docker run -d --restart=always -p 8000:8080 -p 50000:50000 -u root -m 4096m -e
