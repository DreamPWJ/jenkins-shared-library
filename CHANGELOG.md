## 5.10.0
`2025-08-18`
- 新增质量共享库流水线  提供定时、并行、矩阵等质量测试
- 新增Caddy服务器流水线部署 提供更多新服务器支持
- 支持上下游任务关联构建 自动触发多个项目顺序执行

## 5.9.0
`2025-08-01`
- 新增Quarkus项目流水线构建部署 支持新原生超音速框架
- 完善Github项目流水线构建部署  支持更多开源世界工程
- 新增各场景的构建徽章和日志展示  更美观醒目

## 5.8.0
`2025-07-16`
- 新增Gradle自动化构建工具打包 增量并行执行构建更快
- 新增用户可选择分布式node节点 自动调度动态化构建在不同机器上
- 新增是否清空CI/CD工作空间选项  全新构建流水线工作环境
- 支持K8S云原生与容器镜像仓库内网通讯 提高流水线部署效率
