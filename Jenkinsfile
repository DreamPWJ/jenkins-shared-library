 ...
 */
// Pipeline可能需要安装的插件
// Pipeline Maven Integration , NodeJS , Pipeline Utility Steps , DingTalk , Role Strategy , SSH Pipeline Steps,
// build user vars, Blue Ocean, Git Parameter, ThinBackup, Generic Webhook Trigger, Gitlab, HTTP Request ,
// AnsiColor, HTML Publisher, Extended Choice Parameter, Hidden Parameter, Rebuilder, Active Choices
