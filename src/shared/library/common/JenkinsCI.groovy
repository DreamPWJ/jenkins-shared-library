...
class JenkinsCI implements Serializable {
    ...
    static def isAutoTrigger(ctx) {
        ...
        causes.each { cause ->
            ...
            if (cause instanceof hudson.triggers.TimerTrigger.TimerTriggerCause || cause instanceof hudson.scm.SCMTrigger.SCMTriggerCause || cause instanceof hudson.model.Cause.UpstreamCause) {
