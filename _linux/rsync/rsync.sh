...
nohup rsync -avzP --bwlimit=5120 --include "9/" --exclude "/*"  root@119.188.90.222:/nfsdata/ParkPicture/stor1/2022/ /mnt/nfs_data/ParkPicture/stor1/2022/
nohup rsync -avzP --bwlimit=5120 --include "3/" --exclude "/*"  root@119.188.90.222:/nfsdata/ParkPicture/stor1/2023/ /mnt/nfs_data/ParkPicture/stor1/2023/
