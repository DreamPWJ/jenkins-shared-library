...
--cpus=0.8 -m 4096m redis:latest redis-server --appendonly yes --requirepass "panweiji2020"
...
--cpus=0.8 -m 2048m --log-opt max-size=1024m --log-opt max-file=1 \
...
-e TZ="Asia/Shanghai" -e "JAVA_OPT_EXT=-Xms1024M -Xmx1024M -Xmn128m" --cpus=0.8 -m 1048m \
...
-e "JAVA_OPT_EXT=-Xms128m -Xmx1500m" --cpus=0.8 -m 1548m \
...
-e TZ="Asia/Shanghai" -e "JAVA_OPTS=-Drocketmq.namesrv.addr=172.31.3.120:9876 -Xms128m -Xmx512m" --cpus=0.8 -m 1024m \
