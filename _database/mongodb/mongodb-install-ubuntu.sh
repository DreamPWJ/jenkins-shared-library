...
# 官方安装文档: https://docs.mongodb.com/manual/tutorial/install-mongodb-on-ubuntu/
...
# MongoDB 需要关闭 selinux
# cat /etc/selinux/config 将 selinux 参数改为disabled.
