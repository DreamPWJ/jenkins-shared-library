...
nohup rsync -avzP --bwlimit=5120 --include "1/" --exclude "/*"  root@119.188.90.222:/nfs_data/2024/ /mnt/nfs_data/2024/
nohup rsync -avzP --bwlimit=5120  root@119.188.90.222:/nfs_data/2024/ /mnt/nfs_data/2024/
